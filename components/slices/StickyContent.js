...
const StickyContent = ({ slice }) => {
    ...
    <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
      <div className="flex flex-col w-1/3 sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 p-10">
        ...
        <a href="#"
        className="bg-transparent mx-auto hover:bg-white text-white hover:text-black py-2 px-4 border hover:border-transparent">
        Explore Now</a>
      </div>
